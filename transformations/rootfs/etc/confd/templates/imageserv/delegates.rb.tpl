...
=end
  ...
  def httpsource_resource_info(options = {})
    ...
    if values.length == 2
      ...
      return { 'uri' => "http://{{getv "/apache/endpoint"}}/islandora/object/#{pid}/datastream/#{dsid}/view?token=#{token}"}
      ...
      # return "http://{{getv "/apache/endpoint"}}/islandora/object/#{pid}/datastream/#{dsid}/view?token=#{token}"
      return { 'uri' => "http://{{getv "/apache/endpoint"}}/islandora/object/#{pid}/datastream/#{dsid}/view?token=#{token}"}
    else
